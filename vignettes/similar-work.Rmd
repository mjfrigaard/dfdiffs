...
```{r masters, echo=TRUE}
master15 <- readr::read_csv(
  file = "../inst/extdata/app-testing/csv/2015-baseballdatabank/Master.csv")
master20 <- readr::read_csv(
  file = "../inst/extdata/app-testing/csv/2020-baseballdatabank/People.csv")
```
...
This list contains objects named according to `NumDiff` and `VarDiff`. 
