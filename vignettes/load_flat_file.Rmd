---
title: "load_flat_file"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{load_flat_file}
...
This vignette walks through the `load_flat_file()` function, which is used for loading a variety of file types into the `dfdiffs` shiny application. 
